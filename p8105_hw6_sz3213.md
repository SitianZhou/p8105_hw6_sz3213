...
of the distribution are 0.889 and 0.94, respectively, and the
corresponding 95% confidence interval is (0.889, 0.94).
...
2.5% and 97.5% quantiles of the distribution are -8.978 and -4.54,
respectively, and the corresponding 95% confidence interval is (-8.978,
-4.54).
