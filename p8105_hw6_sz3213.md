...
of the distribution are 0.89 and 0.94, respectively, and the
corresponding 95% confidence interval is (0.89, 0.94).
...
2.5% and 97.5% quantiles of the distribution are -8.885 and -4.59,
respectively, and the corresponding 95% confidence interval is (-8.885,
-4.59).
